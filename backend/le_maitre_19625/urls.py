"""le_maitre_19625 URL Configuration
...
admin.site.site_header = "Le Maitre"
admin.site.site_title = "Le Maitre Admin Portal"
admin.site.index_title = "Le Maitre Admin"

# swagger
api_info = openapi.Info(
    title="Le Maitre API",
    default_version="v1",
    description="API documentation for Le Maitre App",
)
